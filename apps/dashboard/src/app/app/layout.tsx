        ...
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-6">
          <div className="flex items-center gap-6">
            ...
            <nav className="flex flex-wrap items-center gap-1 text-sm text-fg-muted">
              ...
              <Link href={'/app/trends' as any} className="rounded-md px-3 py-1.5 hover:bg-bg-subtle">Trends</Link>
              <Link href={'/app/sla' as any} className="rounded-md px-3 py-1.5 hover:bg-bg-subtle">SLA</Link>
