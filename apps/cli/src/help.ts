...
Usage:
  ...
  clawreview presets diff <a> <b> [--root <dir>] [--format text|yaml|json] [--only-fields <a,b,c> | --exclude-fields <a,b,c>] [--output <path>|-] [--max-output-bytes <n>] [--since <git-ref>] [--since-base <ref>] [--since-target <ref>] [--since-range <a>..<b>|<a>...<b>] [--on-delta <cmd> | --on-delta-template slack|webhook]
  ...
  clawreview review filter-report --diff <baseReviewId> <targetReviewId> --server <url> [--format text|json] [--output <path>|-] [--json-stream] [--input <path>|-] [--input-strict] [--on-delta <cmd> | --on-delta-template slack|webhook] [--on-delta-once | --on-delta-once-per <minutes>]
