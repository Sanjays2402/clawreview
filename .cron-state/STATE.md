...
- **Command palette: group count badges** — the palette section headers ("navigate", "recent reviews") could show a small count of matches in each group, so a fuzzy query that narrows to 2 reviews vs 8 routes is legible at a glance.
